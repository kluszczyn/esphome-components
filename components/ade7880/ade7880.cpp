...
void ADE7880::update() {
  ...
  if (this->channel_a_ != nullptr) {
    ...
    this->update_sensor_from_s32_register16_(chan->forward_active_energy, AWATTHR, [&chan](float val) {
      return chan->forward_active_energy_total += val / 14400.0f;
    });
    this->update_sensor_from_s32_register16_(chan->reverse_active_energy, AVAHR, [&chan](float val) {
  ...
  if (this->channel_b_ != nullptr) {
    ...
    this->update_sensor_from_s16_register16_(chan->power_factor, BPF,
                                             [](float val) { return std::abs(val / -327.68f); });
    this->update_sensor_from_s32_register16_(chan->forward_active_energy, BWATTHR, [&chan](float val) {
      return chan->forward_active_energy_total += val / 14400.0f;
    });
    this->update_sensor_from_s32_register16_(chan->reverse_active_energy, BVAHR, [&chan](float val) {
      return chan->reverse_active_energy_total += val / 14400.0f;
    });
  }
  ...
  if (this->channel_c_ != nullptr) {
    ...
    this->update_sensor_from_s16_register16_(chan->power_factor, CPF,
                                             [](float val) { return std::abs(val / -327.68f); });
    this->update_sensor_from_s32_register16_(chan->forward_active_energy, CWATTHR, [&chan](float val) {
      return chan->forward_active_energy_total += val / 14400.0f;
    });
    this->update_sensor_from_s32_register16_(chan->reverse_active_energy, CVAHR, [&chan](float val) {
      return chan->reverse_active_energy_total += val / 14400.0f;
    });
  }
